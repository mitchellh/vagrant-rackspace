...
rem ren C:\cloud-automation\install-chef.cmd install-chef.ps1
rem @powershell -NoProfile -ExecutionPolicy unrestricted -File C:\cloud-automation\install-chef.ps1
